...
- (NSInteger)shouldReturnANegativeNSInteger {
    NSInteger myInt = -7;
    NSInteger otherInt = -600;
    NSInteger myMath = otherInt - myInt;
    return myMath;
...
- (CGFloat)shouldReturnAPositiveCGFloat {
    CGFloat myFloat = 2.667;
    CGFloat thisFloat = 7662.2;
    CGFloat bigFloat = thisFloat / myFloat;
    return bigFloat;
}
